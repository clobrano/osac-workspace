...
**CI builds HTML automatically** — the `GitHub Pages` workflow builds all decks, generates `index.html`, and deploys to GitHub Pages on every push to `main`. You only need to commit the `.md` file.
